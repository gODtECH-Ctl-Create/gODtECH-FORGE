...
const requiredControlledText = [
  ...
  'same base commit', 'not claim provider-token or credit savings', 'incident audit events', 'API tests and build', 'database runtime probes',
  'feature work while outage or failure language remains bug work'
];
