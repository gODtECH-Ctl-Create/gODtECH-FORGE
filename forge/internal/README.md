...
1. `VISION.md` — what FORGE is becoming.
2. `BUILD-SPEC.md` — the technical blueprint.
3. `MODULES.md` — subsystem boundaries and ownership.
4. `ROADMAP.md` — implementation sequence and pick-up work.
5. `CONTRIBUTING.md` — how contributors should work.
