...
For user-facing work, consider accessibility, responsive behavior, interaction quality, and visual verification. For security-sensitive work, apply the relevant security reasoning before implementation.

Before declaring work complete, run the applicable project checks and report their results honestly.
